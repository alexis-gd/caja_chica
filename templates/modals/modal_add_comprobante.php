        ...
        <form id="form-add-comprobante">
          ...
          <div class="form-row box p-3">
            ...
            <div class="form-group mb-0 col-md-12">
              ...
              <select name="modal_comprobante_add_comprobante" id="modal_comprobante_add_comprobante" class="form-control selectize" data-select-id="modelo_comprobante"></select>
            </div>
